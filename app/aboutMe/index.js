...
export default () => {
  ...
  const text = `
I'm a ${age} years old programmer from Slovakia, living in Brno, Czech Republic. Computers have been my passion ever since I was little.
...
it became the biggest focus of my programming. I've created my own game engine, SloN, and upon that I have built TODO LINK [SpaceShip]() and, most notably [UFO]().
...
in 2017 as a bachelor. For my [dissertation](http://is.muni.cz/th/422747/fi_b/), I have created [Scenária](https://github.com/jkbmat/Bakalarska-praca), an online scene editor that uses Box2D physics library and is capable 
